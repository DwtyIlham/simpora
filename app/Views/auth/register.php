            ...
            <div class="max-w-464-px mx-auto w-100">
                ...
                <form action="<?= base_url(); ?>auth/register-attempt" method="post">
                    ...
                    <div class="icon-field mb-16">
                        ...
                        <input type="text" name="username" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Username" autocomplete="off" required>
                    </div>
                    <div class="icon-field mb-16">
                        <span class="icon top-50 translate-middle-y">
                            <iconify-icon icon="mage:note-with-text"></iconify-icon>
                        </span>
                        <input type="text" name="nama" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Nama Lengkap" autocomplete="off" required>
                    </div>
