                        ...
                        foreach ($peserta as $p): ?>
                            <tr>
                                ...
                                <td class="text-center align-middle m-auto">
                                    ...
                                    <a href="<?= site_url('admin/kompetisi/edit/') . $p['id']; ?>" class="btn-edit w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                    ...
                    <div class="card-body m-auto p-1">
                        <div class="idcard" style="text-align: center;">
                            ...
                            <div class="header d-flex align-items-center justify-content-between text-center">
                                ...
                                <img src="<?= base_url('public/assets/images/icon.png') ?>" class="logo img-fluid" />
                            </div>
                            <!-- Foto -->
