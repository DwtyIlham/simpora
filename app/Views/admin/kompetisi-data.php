                        ...
                        foreach ($kompetisi as $k): ?>
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    ...
                                    <?php if (isAdmin()): ?>
                                        <a href="<?= site_url('admin/kompetisi/add/') . $k['id']; ?>" class="btn-edit w-32-px h-32-px bg-warning-focus text-warning-main rounded-circle d-inline-flex align-items-center justify-content-center">
